...
export async function fetchMeals() {
  const response = await fetch(`https://butchery-shop-api.onrender.com/barbecue`);
...
export async function fetchLocations() {
  const response = await fetch(`https://butchery-shop-api.onrender.com/locations`);
...
export async function fetchShopProducts() {
  const response = await fetch(`https://butchery-shop-api.onrender.com/shop`);
...
export async function fetchCartData() {
  const response = await fetch(`https://butchery-shop-api.onrender.com/shop/cart`);
...
export async function postCartData(cartProd: cartProdsData) {
  const response = await fetch(`https://butchery-shop-api.onrender.com/shop/add-to-cart`, {
    method: "POST",
...
export async function updateQty(updatingProps:{cartItem:cartProdsData,Url:string}) {
  const response = await fetch(
    `https://butchery-shop-api.onrender.com/shop/cart/${updatingProps.Url}-qty`,
    {
      method: "POST",
  ...
  if (!response.ok)
    throw new Error("an error occured when updating qty cart item");
